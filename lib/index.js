...
if (!argv.type || !argv.n) {
    console.log(params.help());
    console.log('--name and --type options are required');
    process.exit(0);
}
...
if (argv.type === 'cs') {
    runner.generateFile({ dst: 'src/index.coffee', data: '#TODO: implement' })
} else {
    runner.generateFile({ dst: 'lib/index.js', data: '//TODO: implement' })
}
